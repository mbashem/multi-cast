...
//     // var callerCandidatesCollection = roomRef.collecsocket_io_clienttion('callerCandidates');
...
//     var roomId = "";
//     logger.i('New room created with SDK offer. Room ID: $roomId');
...
//       logger.i('Got updated room: ${snapshot.data()}');
...
//     // we dont' need remote ice candidates?
...
//     //       logger.i('Got new remote ICE candidate: ${jsonEncode(data)}');
...
//     logger.i('Got room ${roomSnapshot.exists}');
...
//       peerConnection!.onIceCandidate = (RTCIceCandidate? candidate) {
//         if (candidate == null) {
//           logger.i('onIceCandidate: complete!');
//           return;
//         }
//         logger.i('onIceCandidate: ${candidate.toMap()}');
